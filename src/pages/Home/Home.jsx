...
import ImagemHome from "./../../assets/images/img-home.jpg";
import ImagemSection from "./../../assets/images/img-section.jpg";

function Home() {
    return (
        <div>
            <div className="container-image">
                    <img className="image-principal" src={ImagemHome} />
            ...
            <div className="container">
                ...
                <section className="content split-section">
                    ...
                    <img className="image-section" src={ImagemSection} />
                </section>
            </div>
        </div>
    )
